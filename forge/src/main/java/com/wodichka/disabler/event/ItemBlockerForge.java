...
import com.wodichka.disabler.item.ForgeStorageSanitizer;
...
public final class ItemBlockerForge {
    ...
    public void onItemPickup(EntityItemPickupEvent event) {
        if (BlockedItemCleaner.isBlocked(event.getItem().getItem())) {
