...
public final class DisablerModifiers {
    ...
    private static final DeferredRegister<Codec<? extends IGlobalLootModifier>> LOOT_MODIFIER_SERIALIZERS = DeferredRegister.create(ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, Disabler.MODID);
    ...
    public static final RegistryObject<Codec<ConfigDrivenLootModifier>> CONFIG_LOOT_BLOCKER = LOOT_MODIFIER_SERIALIZERS.register("config_loot_blocker", () -> ConfigDrivenLootModifier.CODEC);
