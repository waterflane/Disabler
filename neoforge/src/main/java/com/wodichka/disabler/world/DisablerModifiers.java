...
public final class DisablerModifiers {
    ...
    private static final DeferredRegister<MapCodec<? extends IGlobalLootModifier>> LOOT_MODIFIER_SERIALIZERS = DeferredRegister.create(NeoForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, Disabler.MODID);
    ...
    public static final DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<ConfigDrivenLootModifier>> CONFIG_LOOT_BLOCKER = LOOT_MODIFIER_SERIALIZERS.register("config_loot_blocker", () -> ConfigDrivenLootModifier.CODEC);
